...
import { deleteBook } from '../../API/baseApi';

export const ConfirmDeleteModal = ({code,openModal,setOpenModal}) => {
  
  const handleSubmit = async (e) => {
      e.preventDefault();
      //  Deleting the book of the given code
          ...
          <div className='bg-[#F9D745]'>
              <div className="mt-6 text-black">
                  ...
                  <div className=" w-4/5 mx-auto">
                      <div className="text-sm text-gray-600 text-center">Are you Sure you want to delete this book?</div>
                  </div>
                  
                  <div className="flex justify-center mx-auto w-4/5 my-8">
                      <Button className="bg-blue-550 w-full rounded-xl py-4 text-white" onClick={handleSubmit}>Confirm Delete</Button>
                  </div>
